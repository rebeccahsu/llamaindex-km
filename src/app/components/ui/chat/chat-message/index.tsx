...
function ChatMessageContent({
  ...
  const citationIds = extractCitationIds(message.content);
  ...
  const shouldShowSources =
    ...
    && !message.content.includes('[no-sources]')
    && message.content.includes('[citation:');
  ...
  const contents: ContentDisplayConfig[] = [
    ...
    {
      order: 3,
      component: shouldShowSources
        ? <ChatSources data={sourceData[0]} citationIds={citationIds}/>
        : null,
    },
    {
      order: 4,
