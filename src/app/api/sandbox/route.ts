...
export async function POST(req: Request) {
  ...
  // FIXME: Type error: Argument of type 'Buffer<ArrayBufferLike>' is not assignable to parameter of type 'string | ArrayBuffer | Blob | ReadableStream<any>'. Type 'Buffer<ArrayBufferLike>' is missing the following properties from type 'ArrayBuffer': maxByteLength, resizable, resize, detached, and 2 more.
  // Copy files
  // if (artifact.files) {
